...
function registerHelpers (destination) {
  handlebars.registerHelper({
    ...
    // Block helper to conditionally render based on _enabled flag
    // Handles string "false" as false, undefined/missing as true (default enabled)
    isEnabled: function (value, options) {
      const isEnabled = !(value === 'false' || value === false)
      if (isEnabled) {
...
module.exports = {
  createTemplate,
  __registerHelpers: registerHelpers
}
