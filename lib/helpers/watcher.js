...
function installWatcher (startingFolder, callback) {
  ...
  const watcher = createWatcher(...getDataWatchPatterns(startingFolder))
...
function installDevelopmentWatcher (startingFolder, callback) {
  ...
  const watcher = createWatcher(templateFolder, ...getDataWatchPatterns(startingFolder))
...
function getDataWatchPatterns (startingFolder) {
  return [
    path.join(startingFolder, '**/data.xml'),
    path.join(startingFolder, '**/data.json')
  ]
}
